            ...
            for param, values in query_params.items():
                for payload in XSS_PAYLOADS:
                    ...
                    if result and result["xss_detected"]:
                        print(Fore.GREEN + f"[XSS Found] URL: {new_url}, Payload: {payload}")
        ...
        # Test POST requests with payloads
            ...
            for payload in XSS_PAYLOADS:
                ...
                try:
                    ...
                    if result and result["xss_detected"]:
                        print(Fore.GREEN + f"[XSS Found] URL: {url}, Payload: {payload}")
        ...
        if any(ct in content_type for ct in XSS_CONTENT_TYPES):
            for payload in XSS_PAYLOADS:
                if payload in response.text:
                    ...
                    print(Fore.RED + f"[XSS Detected] {url} (Payload: {payload})")
